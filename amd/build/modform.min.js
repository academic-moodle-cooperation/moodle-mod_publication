 ...
 */
define("mod_publication/modform",["jquery"],(function($){const $approvalFromDate=$("#fitem_id_approvalfromdate"),$approvalToDate=$("#fitem_id_approvaltodate"),$obtainStudentApproval=$("#fitem_id_obtainstudentapproval"),$obtainGroupApproval=$("#fitem_id_obtaingroupapproval"),$selectObtainStudentApproval=$("#id_obtainstudentapproval"),$selectObtainGroupApproval=$("#id_obtaingroupapproval"),changeObtainStudentApproval=function(){let isAutomatic=!1;"hidden"!==$obtainStudentApproval.attr("hidden")?isAutomatic="0"===$selectObtainStudentApproval.val():"hidden"!==$obtainGroupApproval.attr("hidden")&&(isAutomatic="-1"===$selectObtainGroupApproval.val()),isAutomatic?($approvalFromDate.attr("hidden","hidden").css("display","none"),$approvalToDate.attr("hidden","hidden").css("display","none")):($approvalFromDate.removeAttr("hidden").css("display","flex"),$approvalToDate.removeAttr("hidden").css("display","flex"))};$selectObtainStudentApproval.on("change",changeObtainStudentApproval),$selectObtainGroupApproval.on("change",changeObtainStudentApproval),changeObtainStudentApproval()}));
